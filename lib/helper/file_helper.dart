...
class FileHelper {
  ...
  static Widget showAttachementIcon({required BuildContext context, required String fileName, double iconSize = 17, double fontSize = 12}) {
    ...
    return WidgetHelper.item(context: context, fileName: fileName, label: fileInfo.label, icon: fileInfo.iconData, color: fileInfo.color, iconSize: iconSize, fontSize: fontSize);
  }
}
